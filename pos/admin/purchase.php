                        ...
                        <form>
                          ...
                          <option value="">cash:</option>
                           <option value="">check:</option>
                            ...
                            <b>purchase time: </b><input type="date" id="purchasetime">
                                        ...
                                        <table id="itemsTable" class="table table-condensed table-responsive">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th> <input type="button" class="btn btn-success" id="puchaseitem" value="submit" colspan="7"></th>
