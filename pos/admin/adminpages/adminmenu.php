<div class="collapse navbar-collapse" id="navbarResponsive">
           ...
           <!-- <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
                ...
                <ul class="sidenav-second-level collapse" id="collapseComponents">
                    ...
                    <li>
                        <a href="NGCRUD3/index.html" id="employee">Employee Data</a>
                ...
                <ul class="sidenav-second-level collapse" id="collapseComments">
                    <li>
                        <a href="commentsall.php">All Comments</a>
                    </li>                    
    ...
    <form class="form-inline my-2 my-lg-0 mr-lg-2" >
              ...
              <span class="input-group-btn">
                ...
                <li class="nav-item" >
                <a class="nav-link" data-toggle="modal" data-target="#exampleModal" style="color:#fff;font-size:15px" href="../logout.php">
